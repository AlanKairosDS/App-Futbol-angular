...
@Component({
  selector: 'app-varonil',
  templateUrl: './varonil.component.html',
  styleUrls: ['./varonil.component.scss'],
})
export class VaronilComponent {
  ...
  registrarEquiposLiga() {
    this.ligaService.agregar_equipo_liga('Varonil', this.dataSelectLigas.id, this.dataSelectEquipos.id).subscribe({
      next: () => {
  ...
  registrarPartidosLiga() {
    this.ligaService.agregar_partido_liga('Varonil', this.dataSelectLigas.id, this.dataSelectPartidos.id).subscribe({
      next: () => {
        let dialogSuccess = this.dialog.open(DialogComponent);
        dialogSuccess.componentInstance.header = this.headerSuccess;
        dialogSuccess.componentInstance.message = this.registroSuccess;
  ...
  registrarTablaGenLiga() {
    this.ligaService.agregar_tabla_liga('Varonil', this.dataSelectLigas.id, this.dataSelectTabla.id).subscribe({
      next: () => {
        let dialogSuccess = this.dialog.open(DialogComponent);
        dialogSuccess.componentInstance.header = this.headerSuccess;
        dialogSuccess.componentInstance.message = this.registroSuccess;
  ...
  registrarResultadosLiga() {
    this.ligaService
      .agregar_resultado_liga('Varonil', this.dataSelectLigas.id, this.dataSelectResultados.id)
      .subscribe({
        next: () => {
          let dialogSuccess = this.dialog.open(DialogComponent);
          dialogSuccess.componentInstance.header = this.headerSuccess;
  ...
  registrarGolesLiga() {
    this.ligaService.agregar_goles_liga('Varonil', this.dataSelectLigas.id, this.dataSelectGoles.id).subscribe({
      next: () => {
        let dialogSuccess = this.dialog.open(DialogComponent);
        dialogSuccess.componentInstance.header = this.headerSuccess;
        dialogSuccess.componentInstance.message = this.registroSuccess;
  ...
  registrarTarjetasLiga() {
    this.ligaService.agregar_tarjetas_liga('Varonil', this.dataSelectLigas.id, this.dataSelectTarjetas.id).subscribe({
      next: () => {
        let dialogSuccess = this.dialog.open(DialogComponent);
        dialogSuccess.componentInstance.header = this.headerSuccess;
        dialogSuccess.componentInstance.message = this.registroSuccess;
  ...
  registrarMvpLiga() {
    this.ligaService.agregar_mvp_liga('Varonil', this.dataSelectLigas.id, this.dataSelectMvp.id).subscribe({
      next: () => {
        let dialogSuccess = this.dialog.open(DialogComponent);
        dialogSuccess.componentInstance.header = this.headerSuccess;
        dialogSuccess.componentInstance.message = this.registroSuccess;
